...
function grid_editor_builder(panel, editor){
    open_modal({title: I18n.t("mvm_js.editor.enter_content"), modal_settings: { keyboard: false, backdrop: "static" }, show_footer: true, content: "<textarea rows='10' class='form-control'></textarea>", callback: function(modal){
