...
window.grid_image_builder = (panel, editor)->
    form = $('<form>'+
        '<div class="form-group"><label class="control-label">'+I18n.t("mvm_js.image.media")+'</label>
    ...
    open_modal({title: I18n.t("mvm_js.image.image_form"), modal_size: "modal-lg", modal_settings: { keyboard: false, backdrop: "static" }, content: form, callback: form_callback, on_submit: submit_form_callback })
